...
"html,body {font-family: 'Georgia';margin: 0;padding: 0;width: 100\%;height: 100\%;overflow: hidden;}"
".but {width: calc(100% / 5);float: left;text-align: center;color: white;}"
"#b1,#b3,#b5 {height: 100%;background-color: black; font-size:50%;}"
"#b2,#b4 {height: 100%;background-color: #0a0a0a; font-size:50%;}"
